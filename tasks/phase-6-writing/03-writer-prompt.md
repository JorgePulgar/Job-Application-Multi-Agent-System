...
## Acceptance criteria
- [ ] `src/prompts/application_writer.system.md` (Spanish):
...
- [ ] `src/prompts/application_writer.user.md`: variables `{{titulo}}`, `{{empresa}}`, `{{ubicacion}}`, `{{modalidad}}`, `{{descripcion}}`, `{{dossier_summary}}`, `{{evaluation_ventajas}}`, `{{evaluation_desventajas}}`, `{{target_roles}}`.
- [ ] Few-shot examples (1-2) of correct outputs, in Spanish, demonstrating specificity.
- [ ] Prompt itself contains no prohibited words.
