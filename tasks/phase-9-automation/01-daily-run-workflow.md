...
## Acceptance criteria
- [ ] `.github/workflows/daily-run.yml` with cron trigger at `05:00 UTC` (= 07:00 CET in winter, 07:00 CEST adjusts — accept the off-by-one in winter; document in a YAML comment).
