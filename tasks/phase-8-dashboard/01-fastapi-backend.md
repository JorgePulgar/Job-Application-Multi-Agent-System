...
## Acceptance criteria
- [x] `api/main.py` (FastAPI app) with routers:
...
- [x] All endpoints typed with Pydantic response models.
- [x] CORS configured to allow the Vercel dashboard origin (env-driven).
- [x] Single SQLAlchemy session per request (FastAPI dependency).
